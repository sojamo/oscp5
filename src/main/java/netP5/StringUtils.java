...
public class StringUtils extends Object {
	...
	/**
	 * Returns the substring to the right of the specified substring in the specified String,
	 ...
	 * @param searchFor
	 *            the substring to search for in source.
	 * @return the substring that is to the right of searchFor in source, starting from the right.
	 */
	...
	/**
	 * Returns the substring to the left of the specified substring in the specified String,
	 * starting from the left.
	 * 
	 * @param source
	 *            the source String to search.
	 ...
	 * @param searchFor
	 *            the substring to search for in source.
	 * @return the substring that is to the left of searchFor in source, starting from the right.
	 */
	 ...
	 * StringUtils.middle("This i a big challenge", "a", "challenge") returns " big ".
	 * 
	 * @param source
	...
	/**
	 * Returns a substring of a String, starting from specified index and with specified length. I.
	 * e. StringUtils.middle("This is a big challenge", 5, 6) returns " is a "
	 * 
	 * @param source
	 ...
	 * @return an array of Strings with the same number of elements as the number of elements in the
	 *         lengths argument. The length of each String element is specified by the correspondent
	 *         lengths array element.
	 ...
	 * @return an array of strings that are made out of splitting the string at the spaces.
	 */
	...
	/**
	 * Splits a string into an array with the specified delimiter. Original code Copyright (C)
	 * 2001,2002 Stephen Ostermiller http://ostermiller.org/utils/StringHelper.java.html
	 * 
	 * <p>
	 * This method is meant to be similar to the split function in other programming languages but
	 * it does not use regular expressions. Rather the String is split on a single String literal.
	 ...
	 *          </p>
	 *          <p>
	 *          If there is no delimiter because it is either empty or null, the only element in the
	 ...
	 * @return an array of strings that are made out of splitting the string at the specified
	 *         delimiter.
	 ...
	 */
	protected static String VALID_RANDOM_CHARACTERS = "abcdefghijkmnopqrstuvwxyz" + "ABCDEFGHJKLMNPQRSTUVWXYZ-_.,;:<>()1234567890%&/=?+";
	 ...
	 * @param searchFor
	 *            the substring that can only occur one at a time, several can exist in the source
	 *            though.
	 */
	...
	/**
	 * A utility method to remove duplicate characters from a string. For example, it would convert
	 * "hello" to "helo", and "abcd123abcaaa" to "abcd123".
	 * 
	 * @param source
	...
	/**
	 * Creates a string of the given width with the given string left justified (followed by an
	 ...
	 * @return the source String padded with spaces to fill up the length. If the source string is
	 *         longer than the length argument, the source String is returned.
	 */
	...
	/**
	 * Creates a string of the given width with the given string right justified (with an
	 * appropriate number of spaces before it).
	 * 
	 * @param source
	 *            the String to justify
	 * @param length
	...
	/**
	 * Creates a string of the given width with the given string left justified (padded by an
	 * appropriate number of spaces in front and after it).
	 * 
	 * @param source
	 *            the String to justify
	 * @param length
	 ...
	 * @return a String consisting of the specified source String copied the specified number of
	 *         times.
	 */
	...
	/**
	 * Switches the case of the supplied String. Any lower case characters will be uppercase and
	 * vice versa.
	 * 
	 * @param source
	...
	/**
	 * Switches the case of the supplied character. A lower case character will be uppercase and
	 * vice versa.
	 * 
	 * @param source
